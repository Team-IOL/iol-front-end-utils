 ...
 */
export const IS_FILE_LARGER_100MB = (fileSize: number): boolean => {
 ...
 */
export const IS_FILE_LARGER_5MB = (fileSize: number): boolean => {
 ...
 */
export const IS_FILE_LARGER_3MB = (fileSize: number): boolean => {
