...
function isEmpty(value) {
  ...
  if (isArrayLike$2(value) &&
      (isArray$5(value) || typeof value == 'string' || typeof value.splice == 'function' ||
        isBuffer$2(value) || isTypedArray$2(value) || isArguments$2(value))) {
    return !value.length;
  }
 ...
 */
var createSet$1 = !(Set && (1 / setToArray$1(new Set([,-0]))[1]) == INFINITY$1) ? noop : function(values) {
...
var xorWith$1 = /*@__PURE__*/getDefaultExportFromCjs(xorWith_1);
 ...
 */
const IS_ARRAY_EQUAL = (arr1, arr2) => isEmpty$1(xorWith$1(arr1, arr2, isEqual$1));
...
const customCapitalize = ({ string, character }) => {
    if (string.includes(character))
        return string.split(character).map(capitalize$1).join(character);
    return capitalize$1(string);
};
